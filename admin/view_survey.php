			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						...
						<p>Survey link: <b><?php echo $link; ?></b></p>
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					...
					<!-- <a href="./index.php?page=add_question&id=<?php echo $_GET['id'] ?>" class="nav-link nav-new_user tree-item"> -->
						<button class="btn btn-block btn-sm btn-default btn-flat border-success new_question" type="button"><i class="fa fa-plus"></i> Add New Question</button></a>
					</div>
				</div>

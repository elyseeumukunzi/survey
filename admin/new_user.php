				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<input type="text" name="companyname" class="form-control fzorm-control-sm" required value="<?php echo isset($companyname) ? $companyname : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">TIN number</label>
							<input type="text" name="tin" class="form-control form-control-sm" required value="<?php echo isset($tin) ? $tin : '' ?>">
						</div>
						<div class="form-group">
